...
import EpFavoriteBtn from "@/components/nano/EpFavoriteBtn";
    ...
    <Drawer
      ...
      <DrawerContent>
        <ScrollArea className="w-full h-[calc(100dvh-2.5rem)] px-6 sm:px-10 md:px-16">
          <div className="h-[calc(100dvh-2.5rem)] min-h-[608px] w-full py-20 flex flex-col justify-between md:justify-end">
            ...
            <div className="w-full pt-16">
              ...
              <div className="w-full md:pt-4 flex gap-2 lg:gap-4 items-center justify-between">
                ...
                <div className="gap-2 lg:gap-4 flex items-center flex-1 justify-center">
                  <EpSkipBackBtn size="large" />
                  <EpPlayBtn size="large" />
                  <EpSkipForwardBtn size="large" />
                </div>
